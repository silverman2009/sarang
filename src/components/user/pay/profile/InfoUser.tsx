            ...
            <div className='border-b border-gray-200 pb-5'>
                <div className='  py-6 h-full  flex justify-between items-center'>
                    <div className='flex items-center gap-1 '>
                        <ImageProfile />
                        <div>
                            <p className='font-artin-bold text-xl'>{user?.FirstName} {user?.LastName}</p>
                ...
                <div className='flex items-center justify-between '>
                    ...
                    <p className='font-artin-bold text-orange_light text-xl'>{user?.Balance} <span className='text-[#626262] text-sm'>تومان</span></p>
                </div>
            </div>
        </>
    )
