...
const InformationPayWithCode = () => {
  return (
    ...
    <nav className='mt-5'>
        <p className='font-artin-regular text-[#626262]'>برای پرداخت با کد راننده، لطفا کد ۵ رقمی را در کادر زیر وارد کنید</p>
        <ul className='flex flex-col gap-2 mt-3'>
            ...
            <li className='flex items-start  gap-3'>
                <span className='block w-1 h-1 mt-3 bg-gray-800 rounded-full'></span>
                <p className='font-artin-regular'>بعد از وارد کد کد، اطلاعات راننده را میتوانید مشاهده و کرایه را پرداخت  کنید</p>
            </li>
        </ul>
    </nav>
</div>
