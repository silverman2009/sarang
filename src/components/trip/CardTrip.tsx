        ...
        <div className='layout bg-white shadow rounded-lg p-2'>
            <div className='flex items-center justify-between border-b border-gray-200 pb-2'>
                <div className='flex items-center gap-2 text-gray-700'>
                    <FaCar size={24} />
                    <p className='font-artin-bold text-lg'>
                        نوع تاکسی :</p>
            ...
            <div className='flex items-center  justify-between py-3 border-b border-gray-200'>
                <p className='flex items-center gap-2 font-artin-black text-gray-700'>
                    ...
                    تعداد نفر : <span className='text-orange_light font-artin-regular'>{trip.NumberOfPassengers}</span></p>
                <p className='font-artin-black text-gray-700 flex gap-1'>مبلغ پرداختی : <span className='text-orange_light font-artin-regular'> {trip.UserTransaction.Amount} </span></p>
            </div>

            <p className='font-artin-black text-gray-700 border-b border-gray-200 py-2 flex gap-2'> روش پرداخت : <span className='text-orange_light font-artin-regular'>{trip.PaymentType}</span></p>
