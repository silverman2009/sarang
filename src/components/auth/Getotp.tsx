            ...
            <div className='w-[85%] mx-auto'>
                ...
                <div className='pt-5 flex flex-col gap-4 justify-center items-center'>
                    ...
                    <div className='mt-14 w-full'>
                        <Input formik={formik} name='phone' classInputTag='placeholder:!text-[#fff]' ltr classInput='border-[0.1rem] border-white bg-white/40 text-white' icon={Phone} placeholder='لطفا شماره تماس خود را وارد کنید' />
                    </div>
                </div>
            </div>
        </div>
