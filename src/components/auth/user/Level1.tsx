    ...
    <div className='flex-1 h-full flex justify-between gap-14 flex-col'>
      <div className='layout mt-8'>
        ...
        <div className='mt-5  flex flex-col gap-3'>
          <Input formik={formik} name="firstName" placeholder='برای مثال: بهار' classInput='bg-[#EFF2F6]' label="نام خود را وارد کنید" />
          <Input formik={formik} name='lastName' placeholder='برای مثال: دهقانی' classInput='bg-[#EFF2F6]' label="نام خانوادگی خود را وارد کنید" />
          <Input formik={formik} name='phone' ltr placeholder='09' classInput='bg-[#EFF2F6]' label="شماره تلفن همراه خود را وارد کنید" />
