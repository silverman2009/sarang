...
const Input = ({ icon, placeholder, classInput, ltr, label , placeholderColor="[#d6d6d6]"}: Props) => {
    return (
        <div className=''>
            ...
            <div className={`flex gap-1 w-full h-[52px] rounded-lg px-2 items-center  ${classInput}`}>
                ...
                <input className={`bg-transparent outline-none placeholder:text-right font-artin-regular placeholder:text-${placeholderColor} text-[14px] w-full text-inherit  ${ltr && "ltr"}`} placeholder={placeholder} />
            </div>
