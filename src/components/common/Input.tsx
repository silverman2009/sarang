...
const Input = ({ icon, placeholder, classInput, ltr, label, classInputTag, name, formik, type }: Props) => {
    return (
        <div className="">
            ...
            <div
                className={`flex gap-1 w-full h-[52px] border bg-[#EFF2F6]  rounded-lg px-2 items-center ${formik.touched[name!] && formik.errors[name!] ? "!border-[#E40000]" : "border-transparent"
                    }  ${classInput}`}
            >
                ...
                <input
                    ...
                    name={name}
                    className={`bg-transparent outline-none placeholder:text-right font-artin-regular  text-[14px] w-full text-inherit placeholder:text-[#d6d6d6] ${classInputTag}  ${ltr && "ltr"
